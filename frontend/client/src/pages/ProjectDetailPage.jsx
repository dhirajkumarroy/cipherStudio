...
//   const [consoleOutput, setConsoleOutput] = useState(""); // 🖥️ Output log
...
//       alert("Error loading project. Please check your login and project ID.");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//         { name: project.name, description: project.description, code },
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//       alert("❌ Failed to save code. Please login again or check server.");
//     }
//   };
...
//     try {
//       // Run code safely using Function constructor
...
//       {/* 🖥️ Console Output */}
//       <div className="bg-black text-green-400 font-mono p-4 rounded-lg h-48 overflow-y-auto shadow-inner">
